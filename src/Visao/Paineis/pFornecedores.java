...
public class pFornecedores extends javax.swing.JPanel {

    Validacoes val = new Validacoes();
    Componentes c = new Componentes();
    ControlaFornecedor con = new ControlaFornecedor();

    Fornecedor selectedUser = null;
    int indice = 0;
    boolean actualizavel = false;

    public pFornecedores() {
        initComponents();
        c.mudaFonte(this, 18);
    ...
    private void initComponents() {
        ...
        txtLocalizacao.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        txtLocalizacao.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 1, 0, new java.awt.Color(153, 153, 153)));
        txtLocalizacao.setOpaque(false);
        ...
        btnMenu1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icons/addPerson.png"))); // NOI18N
        ...
        tab.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "NOME", "CONTACTO", "TIPO DE PRODUTOS", "LOCALIZACAO"
            }
        ) {
    ...
    private Fornecedor capturaDados() {
        int id = 1;
        boolean activo = true;
        String nome = val.pegaTxt(txtNome);
        String localizacao = val.pegaTxt(txtLocalizacao);
        String contacto = val.pegaTxt(txtContacto);
        String tipoDeProdutos = val.pegaTxt(cboTipoDeProd);
//        con

        if (nome.length() > 2) {
            if (localizacao.length() > 2) {
                if (contacto.length() == 9) {
                    return new Fornecedor(id, activo, nome, localizacao, contacto, tipoDeProdutos);
                } else {
                    val.errorComp(txtContacto, "Contacto invalido!", Color.WHITE);
                }
            } else {
                val.errorComp(txtLocalizacao, "Localizacao invalida!", Color.WHITE);
            }
        } else {
    ...
    private void btnMenu1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMenu1ActionPerformed
        if (actualizavel) {
            ...
            if (id != 1) {
                ...
                val.msg(btnMenu1, "Nao pode remover um fornecedor padrao!");
            }
        } else {
    ...
    private void tabMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabMouseClicked
        if (tab.getSelectedRow() != -1) {
            ...
            selectedUser = (Fornecedor) con.pesquisar(indice);
    ...
    private void preencheCampos(Fornecedor o) {
        val.poeTxt(txtNome, o.getNome());
        val.poeTxt(txtLocalizacao, o.getLocalizacao());
        val.poeTxt(txtContacto, o.getContacto());
        val.poeTxt(cboTipoDeProd, o.getTipoDeProdutos());
    }

    private void limpar() {
        val.poeTxt(txtNome, "");
        val.poeTxt(txtLocalizacao, "");
        val.poeTxt(txtContacto, "");
        val.poeTxt(cboTipoDeProd, "");
        selectedUser = null;
        actualizavel = false;
        indice = 0;
    }
    ...
    void pesquisar() {
        ...
        for (Fornecedor o : con.lstFornecedor()) {
