...
public class DateTime implements Serializable {
    ...
    public String getData() {
        c = Calendar.getInstance();
        return "" + (c.get(c.DAY_OF_MONTH) + "/" + mesPorExtenco((c.get(c.MONTH) + 1)) + "/" + c.get(c.YEAR));
    }

    public boolean getDataIn(String m, String a1, String a2) {
        String s = getDia() + "*" + m + "=" + a1 + a2;
          return !new Validacoes().e_dataInferiorQueHoje(s);
    }
